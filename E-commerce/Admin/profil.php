...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="resume-section" id="about">
      <div class="resume-section-content card shadow" style="padding: 20px;">
        ...
        <div class="row mb-3">
          <div class="col-sm-10 offset-sm-2">
            ...
            <!-- Button Logout -->
            <a class="btn btn-primary btn-xl text-uppercase text-white fw-bold offset-sm-9" href="index.html">Logout</a>
          </div>
        </div>
      </div>
    </section>
